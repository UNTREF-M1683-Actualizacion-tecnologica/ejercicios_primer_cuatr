...
destino <- "./libro-ingenieros-gutengerg.txt"
...
word_counts1 <- word_counts %>%
  ...
  filter(!(word %in% c("dijo", "hacia", "entonces", "modo", "this", "luego", "aquí", "toda", "gran", "the", "gutenberg", "project", "después", "pues", "3.50", "sólo", "puede", "cada", "nunca", "siempre", "todas", "toda", "mismo", "3,50", "pueden", "with", "frente", "ello", "3,00"))) 
...
top_words <- word_counts1 %>%
  top_n(50, n) #indico la cantidad que deseo
